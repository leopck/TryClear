...
function(a, b) {
    ...
    var V = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        fb = /^\s*<!(?:\[CDATA\[|\-\-)/,
        gb = { option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], area: [1, "<map>", "</map>"], _default: [0, "", ""] },
        hb = U(c);
    ...
    "getBoundingClientRect" in c.documentElement ? vc = function(a, b, c, d) {
        ...
        position: function() {
            ...
            var a = this[0],
                b = this.offsetParent(),
                c = this.offset(),
                d = xc.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset();
...
function(a) {
    ...
    a.fn.console = function(b) {
        ...
        function R(b) {
            ...
            var c = a('<span class="jquery-console-prompt-label"></span>'),
                d = b;
        ...
        function bb() {
            var a = p,
                b = "";
            if (o > 0 && a == "") b = f;
            else if (o == p.length) b = cb(a) + f;
            else {
                var c = a.substring(0, o),
                    d = a.substring(o, o + 1);
        ...
        if (!a.browser.ios) var c = { 37: V, 39: U, 38: C, 40: D, 8: G, 46: H, 35: X, 36: W, 13: K, 10: K, 18: ab };
        else var c = { 127: G, 10: K, 13: K, 8: G };
        var d = { 65: W, 69: X, 68: H, 78: D, 80: C, 66: V, 70: U, 75: I },
            e = { 70: Y, 66: Z, 68: J },
            f = '<span class="jquery-console-cursor">&nbsp;</span>',
            g = a.browser.opera ? "" : "<wbr>&shy;",
            h = a(this),
            i = a('<div class="jquery-console-inner"></div>'),
            j = a('<textarea class="jquery-console-typer"></textarea>'),
            k, l, m = b && b.promptLabel ? b.promptLabel : "> ",
            n = b && b.continuedPromptLabel ? b.continuedPromptLabel : "> ",
            o = 0,
            p = "",
            q = "",
            r = "",
...
JSON || (JSON = {}),
    ...
    function() {
        function A(a, b, c) {
            ...
            if (d == "[object Array]") {
                ...
                if (g)
                    while (f--)
                        if (!(g = f in a == f in b && A(a[f], b[f], c))) break
            } else {
        ...
        var x = w.each = w.forEach = function(a, b, d) {
            ...
            if (k && a.forEach === k) a.forEach(b, d);
                ...
                for (var g in a)
                    if (w.has(a, g) && b.call(d, a[g], g, a) === c) return
        };
    ...
    function() {
        CourseApp.AppRouter = Backbone.Router.extend({
            routes: { "levels/:level_id/challenges/:id": "show", "levels/:level_id": "level" },
    ...
    function() {
        ...
        }), CourseApp.Collections.Challenges = Backbone.Collection.extend({ model: CourseApp.Models.Challenge, url: "/levels/1/challenges" }), CourseApp.Models.Resource = Backbone.Model.extend({
            renderable: function() {
    ...
    function(a) {
        var b = 1,
            c = {},
            d = new RegExp("^(https?://)?gist.github.com/([0-9]+)(#file_(.*))?$");
...
pluginlist += navigator.javaEnabled() ? "Java," : "", pluginlist.length > 0 && (pluginlist = pluginlist.substring(0, pluginlist.length - 1)),
    function() {
        window.FileBrowser = {
            Models: {},
            Collections: {},
    ...
    function() {
        FileBrowser.Views.Directory = Backbone.View.extend({
            ...
            tagName: "ol",
            className: "directory",
            events: { "click [data-directory]": "_handleDirectoryClick", "click [data-file]": "_handleFileClick", click: "_handleRootClick", mousedown: "_handleMouseDown" },
    ...
    function() {
        FileBrowser.Views.FileWindow = Backbone.View.extend({
            ...
            events: { "directoryClick ol": "_handleDirectoryClick", "fileClick ol": "_handleFileClick", "rootClick ol": "_handleRootClick" },
            initialize: function(a) {
    ...
    function() {
        CourseApp.Views.ChallengeDetails = Backbone.View.extend({
            template: _.template('<h1><em><%= level_number %>.<%= number %></em> <span><%= title %></span></h1>\n\n<div id="instructions">\n  <%= instructions %>\n</div>'),
            initialize: function() {
    ...
    function() {
        CourseApp.Views.EditorGroup = Backbone.View.extend({
            view_classes: { console: CourseApp.Views.Console, text: CourseApp.Views.TextEditor },
            events: { "click #manual_submit": "submitCode" },
            initialize: function() {
    ...
    function() {
        CourseApp.Views.ResourceTabs = Backbone.View.extend({
        ...
        }), CourseApp.Views.HintsHeader = CourseApp.Views.TabHeader.extend({}), CourseApp.Views.HintsContent = Backbone.View.extend({
            className: "resource-panel panel",
            id: "hints",
            ...
            events: { "click #next_hint": "nextHint" },
            initialize: function() {
    ...
    function() {
        ...
        function w(a, c) {
            ...
            I(c);
            var e = typeof c.value == "string" ? 0 : c.value.first,
        ...
        function x(a, b) {
            var d = {},
                f = d.input = Ze("textarea", null, null, "position: absolute; padding: 0; width: 1px; height: 1em; outline: none;");
        ...
        function F(a) {
            ...
            for (var d = 0; d < c.length; ++d) {
                var e = c[d],
                    f = b.appendChild(Ze("div", null, "CodeMirror-gutter " + e));
        ...
        function L(a) {
            ...
            var c = O(b) - b.scroller.scrollLeft + a.doc.scrollLeft,
                d = b.gutters.offsetWidth,
                e = c + "px";
            for (var f = b.lineDiv.firstChild; f; f = f.nextSibling)
                if (f.alignable)
        ...
        function M(a) {
            ...
            if (c.length != d.lineNumChars) {
                var e = d.measure.appendChild(Ze("div", [Ze("div", c)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
        ...
        function Q(a, b, d) {
            ...
            for (var w = e.lineDiv.firstChild, x; w; w = w.nextSibling)
                if (w.lineObj) {
                    if (c) {
                    ...
                    if (A > .001 || A < -0.001) {
                        ...
                        if (B)
                            for (var j = 0; j < B.length; ++j) B[j].height = B[j].node.offsetHeight
                    }
                }
        ...
        function U(a, b, c, d, f) {
            ...
            a.doc.iter(b, c, function(b) {
                ...
                if (wd(a.doc, b)) {
                    b.height != 0 && ee(b, 0);
                    if (b.widgets && k.previousSibling)
                    ...
                    if (b.widgets)
                        for (var p = 0, q = k, r; q && p < 20; ++p, q = q.nextSibling)
        ...
        function V(a, b, d, e, f) {
            ...
            if (f) {
                ...
                for (var m = f.firstChild, n; m; m = n) {
                    n = m.nextSibling;
                    if (!/\bCodeMirror-linewidget\b/.test(m.className)) f.removeChild(m);
                    else {
            ...
            c && (j.style.zIndex = 2);
            if (b.widgets && j != f)
                for (var o = 0, w = b.widgets; o < w.length; ++o) {
                    var q = w[o],
                        x = Ze("div", [q.node], "CodeMirror-linewidget");
        ...
        function X(a) {
            var b = a.display,
                c = tc(a.doc.sel.from, a.doc.sel.to);
        ...
        function Z(a) {
            ...
            if (d.from.line == d.to.line) i(d.from.line, d.from.ch, d.to.ch);
                ...
                var j = be(c, d.from.line),
                    k = j,
                    l, m = [d.from.line, d.from.ch],
                    n;
                while (l = ud(k)) {
                    var o = l.find();
                ...
                if (n)
                    for (var p = 0; p < m.length; p += 3) i(m[p], m[p + 1], m[p + 2]);
                else {
        ...
        function cb(a, b) {
            ...
            var e = bb(a, b),
                f = e > c.first && be(c, e - 1).stateAfter;
        ...
        function ib(a, b) {
            ...
            if (!c) {
                ...
                var d = a.display.measureLineCache,
                    e = { text: b.text, width: a.display.scroller.clientWidth, markedSpans: b.markedSpans, measure: c, classes: b.textClass + "|" + b.bgClass + "|" + b.wrapClass };
        ...
        function jb(a, e) {
            ...
            for (var l = 0, t; l < g.length; ++l)
                if (t = g[l]) {
                    var u = bf(t),
                        v = Math.max(0, u.top - p.top),
                        w = Math.min(u.bottom - p.top, s);
        ...
        function kb(a, b) {
            ...
            var g = Nd(a, b),
                h = g.appendChild(hf(a.display.measure));
        ...
        function pb(a, b, c, d, e) {
            ...
            for (var l = 0; l < g.length; ++l) {
                ...
                var q = n ? m.to : m.from,
                    r = n ? m.from : m.to;
                if (q == h) l && m.level < (o = g[l - 1]).level ? p = f(o.level % 2 ? o.from : o.to - 1, !0) : p = f(n && m.from != m.to ? h - 1 : h), n == k ? i = p : j = p;
                else if (r == h) {
        ...
        function yb(a) {
            ...
            if (j)
                for (var l = 0; l < j.length; ++l) j[l].lines.length || Ce(j[l], "hide");
            if (k)
                for (var l = 0; l < k.length; ++l) k[l].lines.length && Ce(k[l], "unhide");
            var m;
        ...
        function Ob(a) {
            ...
            var i = +(new Date),
                j = "single";
            if (Nb && Nb.time > i - 400 && tc(Nb.pos, h)) j = "triple", ve(a), setTimeout(Ue(Hb, c), 20), Qc(c, h.line);
            else if (Mb && Mb.time > i - 400 && tc(Mb.pos, h)) {
        ...
        function gc(a, c) {
            function k() {
                ...
                if (e.input.selectionStart != null && (!b || d)) {
                    clearTimeout(fc);
                    var c = e.input.value = " " + (tc(f.from, f.to) ? "" : e.input.value),
                        g = 0;
        ...
        function Gc(a, b, c) {
            ...
            for (;;) {
                var d = !1,
                    e = pb(a, b),
                    f = Ic(a, e.left, e.top - c, e.left, e.bottom + c),
                    g = a.doc.scrollTop,
                    h = a.doc.scrollLeft;
        ...
        function Ic(a, b, c, d, e) {
            var f = a.display,
                g = db(f);
            c += g, e += g;
            var h = f.scroller.clientHeight - Ie,
            ...
            var n = f.scroller.clientWidth - Ie,
        ...
        function Kc(a, b, c) {
            var d = a.curOp.updateScrollPos || (a.curOp.updateScrollPos = { scrollLeft: a.doc.scrollLeft, scrollTop: a.doc.scrollTop }),
        ...
        function pd(a, b) {
            var c = zc(a, b.from.line) && be(a, b.from.line).markedSpans,
                d = zc(a, b.to.line) && be(a, b.to.line).markedSpans;
            if (!c && !d) return null;
            var e = b.from.ch,
                f = b.to.ch,
                g = tc(b.from, b.to),
            ...
            if (!j) {
                var p = b.text.length - 2,
                    q;
                if (p > 0 && h)
                    for (var l = 0; l < h.length; ++l) h[l].to == null && (q || (q = [])).push({ from: null, to: null, marker: h[l].marker });
        ...
        function Kd(a, b, c) {
            var d = a.doc.mode,
                e = new fd(b.text, a.options.tabSize);
        ...
        function Ud(a, b, c, d, e) {
            ...
            if (h.ch == 0 && i.ch == 0 && m == "") {
                ...
                if (j.length == 1) g(k, k.text.slice(0, h.ch) + m + k.text.slice(i.ch), n);
                else {
            ...
            else if (j.length == 1) g(k, k.text.slice(0, h.ch) + j[0] + l.text.slice(i.ch), f(0)), a.remove(h.line + 1, o);
            else {
        ...
        function pe(a, b) {
            for (var c = 0, d = []; c < a.length; ++c) {
                ...
                for (var h = 0; h < f.length; ++h) {
                    ...
                    if (b)
                        for (var k in i)(j = k.match(/^spans_(\d+)$/)) && Qe(b, Number(j[1])) > -1 && (Oe(g)[k] = i[k], delete i[k])
                }
            }
            return d
        }
        ...
        function re(a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                ...
                for (var h = 0; h < f.changes.length; ++h) {
                    ...
                    if (c < i.from.line) i.from.line += d, i.to.line += d;
                    else if (b <= i.to.line) {
                        g = !1;
                        break
                    }
        ...
        function tf(a, b) {
            ...
            var e = ie(d),
                f = e ? e[0].level % 2 ? qf(d) : rf(d) : d.text.length;
            return sc(b, f)
        }
        ...
        function vf(a, b, c, d) {
            var e = b + c;
            if (d)
                while (e > 0 && Ye.test(a.text.charAt(e))) e += c;
        ...
        w.Pos = sc, w.prototype = {
            ...
            removeKeyMap: function(a) {
                ...
                for (var c = 0; c < b.length; ++c)
                    if ((typeof a == "string" ? b[c].name : b[c]) == a) return b.splice(c, 1), !0
            },
            ...
            getTokenAt: function(a) {
                var b = this.doc;
                a = xc(b, a);
                var c = cb(this, a.line),
                    d = this.doc.mode,
                    e = be(b, a.line),
                    f = new fd(e.text, this.options.tabSize);
        ...
        w.defineMode = function(a, b) {
            ...
            if (typeof a == "string" && Wc.hasOwnProperty(a)) a = Wc[a];
            else if (typeof a == "string" && /^[\w\-]+\/[\w\-]+\+xml$/.test(a)) return w.resolveMode("application/xml");
        ...
        ad.basic = { Left: "goCharLeft", Right: "goCharRight", Up: "goLineUp", Down: "goLineDown", End: "goLineEnd", Home: "goLineStartSmart", PageUp: "goPageUp", PageDown: "goPageDown", Delete: "delCharAfter", Backspace: "delCharBefore", Tab: "defaultTab", "Shift-Tab": "indentAuto", Enter: "newlineAndIndent", Insert: "toggleOverwrite" }, ad.pcDefault = { "Ctrl-A": "selectAll", "Ctrl-D": "deleteLine", "Ctrl-Z": "undo", "Shift-Ctrl-Z": "redo", "Ctrl-Y": "redo", "Ctrl-Home": "goDocStart", "Alt-Up": "goDocStart", "Ctrl-End": "goDocEnd", "Ctrl-Down": "goDocEnd", "Ctrl-Left": "goGroupLeft", "Ctrl-Right": "goGroupRight", "Alt-Left": "goLineStart", "Alt-Right": "goLineEnd", "Ctrl-Backspace": "delGroupBefore", "Ctrl-Delete": "delGroupAfter", "Ctrl-S": "save", "Ctrl-F": "find", "Ctrl-G": "findNext", "Shift-Ctrl-G": "findPrev", "Shift-Ctrl-F": "replace", "Shift-Ctrl-R": "replaceAll", "Ctrl-[": "indentLess", "Ctrl-]": "indentMore", fallthrough: "basic" }, ad.macDefault = { "Cmd-A": "selectAll", "Cmd-D": "deleteLine", "Cmd-Z": "undo", "Shift-Cmd-Z": "redo", "Cmd-Y": "redo", "Cmd-Up": "goDocStart", "Cmd-End": "goDocEnd", "Cmd-Down": "goDocEnd", "Alt-Left": "goGroupLeft", "Alt-Right": "goGroupRight", "Cmd-Left": "goLineStart", "Cmd-Right": "goLineEnd", "Alt-Backspace": "delGroupBefore", "Ctrl-Alt-Backspace": "delGroupAfter", "Alt-Delete": "delGroupAfter", "Cmd-S": "save", "Cmd-F": "find", "Cmd-G": "findNext", "Shift-Cmd-G": "findPrev", "Cmd-Alt-F": "replace", "Shift-Cmd-Alt-F": "replaceAll", "Cmd-[": "indentLess", "Cmd-]": "indentMore", fallthrough: ["basic", "emacsy"] }, ad["default"] = p ? ad.macDefault : ad.pcDefault, ad.emacsy = { "Ctrl-F": "goCharRight", "Ctrl-B": "goCharLeft", "Ctrl-P": "goLineUp", "Ctrl-N": "goLineDown", "Alt-F": "goWordRight", "Alt-B": "goWordLeft", "Ctrl-A": "goLineStart", "Ctrl-E": "goLineEnd", "Ctrl-V": "goPageDown", "Shift-Ctrl-V": "goPageUp", "Ctrl-D": "delCharAfter", "Ctrl-H": "delCharBefore", "Alt-D": "delWordAfter", "Alt-Backspace": "delWordBefore", "Ctrl-K": "killLine", "Ctrl-T": "transposeChars" }, w.lookupKey = cd, w.isModifierKey = dd, w.keyName = ed, w.fromTextArea = function(a, b) {
            ...
            this.lines.splice(Qe(this.lines, a), 1);
            if (!this.lines.length && this.doc.cm) {
                var b = this.doc.cm.curOp;
        ...
        var Me = [""],
            Ve = /[\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc]/,
            Ye = /[\u0300-\u036F\u0483-\u0487\u0488-\u0489\u0591-\u05BD\u05BF\u05C1-\u05C2\u05C4-\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\uA66F\uA670-\uA672\uA674-\uA67D\uA69F\udc00-\udfff]/;
        ...
        window.CSConsole = function() {
            ...
            return d.name = "CSConsole", d.prototype.keyMap = { "Alt-Delete": "delGroupAfter", "Alt-Left": "goGroupLeft", "Alt-Right": "goGroupRight", "Cmd-Right": "goLineEnd", "Ctrl-E": "goLineEnd", "Ctrl-Alt-Backspace": "delGroupAfter", Delete: "delCharAfter", End: "goLineEnd", Home: "goLineStartSmart", PageDown: "goPageDown", PageUp: "goPageUp", Right: "goCharRight", "Ctrl-F": "goCharRight" }, d.prototype.outputWidgets = [], d.prototype.currentLine = 0, d.prototype.submitInProgress = !1, d.prototype.setValue = function(a) {
                ...
                if (a.constructor === Array)
                    for (d = 0, e = a.length; d < e; d++) b = a[d], this.buildWidget(c, b);
                else this.buildWidget(c, a);
            ...
            }, d.prototype.noop = function() {}, c = function() {
                function b(b) {
    ...
    function() {
        $(function() {
            var a, b, c, d, e, f;
            return $(".codeschool-banner.show").show().animate({ bottom: "0" }, 400), $("html").delegate("code.input-inline", "mousedown", function(a) {
                var b, d;
                d = CourseApp.editor_views[0].editor;
				b = $(a.target).html();
